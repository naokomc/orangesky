				...
				<ul class="commentdata">
					<li>
						<?php if (('open' == $post-> comment_status) && ('open' == $post->ping_status)) {
							...
							Both <a href="#respond" title="skip to the bottom to leave a comment">comments</a> and <a href="<?php trackback_url(display); ?>" title="click to see the trackback URI">trackbacks</a> are currenlty <strong>open</strong> for this entry.
						
						<?php } elseif (!('open' == $post-> comment_status) && ('open' == $post->ping_status)) {
							// Only Pings are Open ?>
							Comments are currently <strong>closed</strong>, but you can <a href="<?php trackback_url(display); ?> ">trackback</a> from your site.
					...
					<li>Trackback URI: <input type="text" value="<?php trackback_url(display); ?>" class="tbinput" title="Ctrl (Apple) + A to select URI" /></li>
					<li><?php comments_rss_link('Comments RSS 2.0'); ?></li>
				</ul>
